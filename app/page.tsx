...
export default function Home() {
  ...
  // Estado para alternar entre Inicio y Catálogo Completo
  ...
  // Mostramos los primeros 3 para la sección de Promos en la Home
    ...
    <main className="min-h-screen bg-[#fdfcf0] pb-20 font-sans text-gray-800">
      ...
      {!verTienda ? (
        ...
        <>
          ...
          {/* QUIÉNES SOMOS / ESENCIA (RESTAURADO) */}
        ...
        <section id="productos" className="max-w-6xl mx-auto p-4 pt-16 min-h-screen">
          ...
          {productosFiltrados.length === 0 && (
            <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200">
              <p className="text-gray-500 text-lg italic">No encontramos lo que buscás en esta categoría.</p>
              <button onClick={() => setCategoriaSeleccionada("Todos")} className="mt-4 text-[#4a5d23] font-bold">Mostrar todos los productos</button>
            </div>
          )}
        </section>
      )}
