...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fdfcf0] pb-20 font-sans text-gray-800">
      ...
      <section id="productos" className="max-w-xl mx-auto px-4 mt-16 mb-8">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-gray-100 focus:border-[#4a5d23] outline-none shadow-sm transition-all bg-white"
      ...
      {/* --- LOGO OFICIAL DE WHATSAPP (CORREGIDO) --- */}
      <a
        href="https://wa.me/5493515416836"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 left-6 bg-[#25d366] text-white p-4 rounded-full shadow-2xl z-[100] active:scale-110 transition-transform hover:bg-[#128c7e]"
      >
